...
import (
	...
	testdata "github.com/yujian0213/self-web/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/yujian0213/self-web/framework/gin.handlerNameTest$", c.HandlerName())
}
